...
class CardDetailView extends React.Component<CardDetailViewProps> {
  ...
  render() {
    ...
    if (this.props.cardData) {
      if (
        this.props.cardData.carddate != null &&
    ...
    return (
      <div
        id={"cardlist" + this.props.cardData.cardid}
              ...
              <td valign="top">
                <List component="nav" aria-label="Stack actions">
                  <ListItem button>
                    <ListItemText
                      primary="Close"
                      onClick={this.saveCardEvent}
                    />
                  </ListItem>
                  <ListItem button>
                    <ListItemText
                      primary="Delete card"
                      onClick={this.deleteCardEvent}
                    />
                  </ListItem>
                </List>
              </td>
